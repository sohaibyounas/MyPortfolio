          ...
          <div className="flex-1 text-center lg:text-left space-y-8">
            ...
            <div className="backdrop-blur-sm bg-white/5 dark:bg-white/5 rounded-3xl p-8 lg:p-10 border border-white/10 shadow-2xl">
              ...
              <div className="animate-fade-in-up animation-delay-200">
                <div className="text-xl md:text-2xl lg:text-3xl font-medium mb-6 min-h-[40px] text-white">
                  A passionate{" "}
              ...
              <div className="animate-fade-in-up animation-delay-300">
                <p className="text-base md:text-lg text-gray-300 mb-8 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
              ...
              <div className="animate-fade-in-up animation-delay-300 mb-8">
                <div className="grid grid-cols-3 gap-4 max-w-md mx-auto lg:mx-0">
                  ...
                  <div className="text-center lg:text-left">
                    <div className="text-2xl md:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-purple-400">
                      10+
                    </div>
                    <div className="text-xs md:text-sm text-gray-400">
                      Tech Stack
                ...
                <div className="flex justify-center lg:justify-start gap-3 mb-8">
                  {socialLinks.map((social, index) => (
                    <Button
                      ...
                      variant="outline"
                      size="icon"
                      className="w-12 h-12 rounded-full border-2 border-white/20 bg-white/5 backdrop-blur-sm transition-all duration-300 hover:scale-110 hover:bg-white/10 hover:border-purple-400/50 hover:shadow-lg hover:shadow-purple-500/50 text-white"
                      asChild
                    >
                      <a
                        href={social.href}
              ...
              <div className="animate-fade-in-up animation-delay-500">
                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                  ...
                  <Button
                    size="lg"
                    className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 border-0 hover:scale-105 transition-all duration-300 shadow-lg shadow-purple-500/50 text-white font-semibold"
                    asChild
                  >
                    <a href="#contact">
                  ...
                  <Button
                    variant="outline"
                    size="lg"
                    className="border-2 border-white/20 bg-white/5 backdrop-blur-sm hover:bg-white/10 hover:border-purple-400/50 hover:scale-105 transition-all duration-300 text-white font-semibold"
                    onClick={(e) => {
                      e.preventDefault();
                  ...
                  <Button
                    variant="outline"
                    size="lg"
                    className="border-2 border-white/20 bg-white/5 backdrop-blur-sm hover:bg-white/10 hover:border-cyan-400/50 hover:scale-105 transition-all duration-300 text-white font-semibold"
                    asChild
                  >
          ...
          <div className="flex-1 max-w-md lg:max-w-lg">
            <div className="animate-fade-in-up animation-delay-300">
              <div className="relative">
                ...
                <div className="relative w-72 h-72 md:w-96 md:h-96 mx-auto bg-gradient-to-br from-purple-500/30 to-pink-500/30 rounded-full flex items-center justify-center backdrop-blur-sm border-4 border-white/10 shadow-2xl overflow-hidden group">
