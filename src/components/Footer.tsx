  ...
  return (
    <footer className="bg-secondary/30 border-t border-border">
      <div className="section-container py-12">
        <div className="grid md:grid-cols-3 md:gap-5 lg:gap-8 mb-8">
          {/* Brand */}
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-muted-foreground">
              <p className="text-nowrap">📧 sohaibyounas24@gmail.com</p>
              <p>📱 +92 (303) 6916535</p>
              <p>📍 Lahore, PK</p>
            </div>
            <Button
              className="hero-gradient text-white hover:scale-105 transition-transform duration-300"
